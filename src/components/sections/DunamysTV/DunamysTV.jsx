...
const DunamysTV = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-900 via-purple-800 to-blue-900 py-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-200 text-lg">Canal Oficial | Transformando vidas através da Palavra</p>
              </div>
            </div>
            <div className="hidden md:flex space-x-4">
              <a 
                href="https://www.youtube.com/@dunamystv" 
                target="_blank" 
                rel="noopener noreferrer"
                className="bg-red-600 hover:bg-red-700 px-6 py-3 rounded-lg transition-colors flex items-center space-x-2"
              >
              ...
              <button 
                onClick={fetchYouTubeVideos}
                className="border border-purple-400 hover:bg-purple-600 px-6 py-3 rounded-lg transition-colors"
              >
                🔄 Atualizar
              </button>
            </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="mt-4 lg:mt-0 lg:ml-6 flex flex-col space-y-3">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-red-600 hover:bg-red-700 px-6 py-3 rounded-lg transition-colors text-center"
                    >
                      🎬 Ver no YouTube
                    </a>
                    <button className="border border-gray-600 hover:bg-gray-700 px-6 py-3 rounded-lg transition-colors">
                      💖 {parseInt(selectedVideo.likeCount).toLocaleString('pt-BR')} curtidas
                    </button>
                  </div>
                </div>
              </div>
